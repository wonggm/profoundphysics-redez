---
title: Special Relativity for Dummies: An Intuitive Introduction
category: relativity
date: 2024-09-09
original_url: https://profoundphysics.com/special-relativity-for-dummies-an-intuitive-introduction/
excerpt: The universe doesn't work the way your intuition says it does — and that's the most interesting part.
canonical: false
---

# Special Relativity For Dummies: An Intuitive Introduction

> The universe doesn't work the way your intuition says it does — and that's the most interesting part.

*Originally published at [profoundphysics.com](https://profoundphysics.com/special-relativity-for-dummies-an-intuitive-introduction/).*
...
For example, I have an introductory article called **[General Relativity For Dummies](https://profoundphysics.com/general-relativity-for-dummies/)**, which is one of the most comprehensive articles I’ve ever written. In there I discuss some of the physical and mathematical concepts general relativity is based on.
...
**What special relativity does NOT deal with, is gravity** (i.e. frames with tidal forces and curved spacetime). Gravity is left for general relativity to deal with. In case you are interested, you can read more about this in my **[introductory article on general relativity](https://profoundphysics.com/general-relativity-for-dummies/)**.
...
**Quick tip**: For building a **deep understanding of special relativity**, it’s almost required to have a strong mathematical foundation first (such as multivariable and vector calculus). For this, you may find my online course **[Advanced Math For Physics](https://courses.profoundphysics.com/p/advanced-math-for-physics-a-complete-self-study-course)** useful. The course aims to teach you both the **advanced mathematical tools** needed to understand special and general relativity as well as how these concepts are applied to physics in practice.   
  
You’ll get to learn everything from the **basics** all the way up to topics like **tensor calculus**, which forms the basis for understanding **general relativity**. You’ll also get workbooks with tons of **practice problems** to go along with the course material.
...
$$\left(dS\right)^2=\eta_{00}dx^0dx^0+\eta_{01}dx^0dx^1+\eta_{02}dx^0dx^2+...+\eta_{33}dx^3dx^3\\\left(dS\right)^2=\eta_{00}\left(dx^0\right)^2+\eta_{01}dx^0dx^1+\eta_{02}dx^0dx^2+...+\eta_{33}\left(dx^3\right)^2$$
...
Anyway, the dx’s in full spacetime are defined as $dx^0=cdt{,}\ dx^1=dx{,}\ dx^2=dy$ and $dx^3=dz$.

We can then replace the dx’s with these in our spacetime interval:
...
$$\left(dS\right)^2=1\cdot\left(cdt\right)^2+\left(-1\right)\cdot\left(dx\right)^2+\left(-1\right)\cdot\left(dy\right)^2+\left(-1\right)\cdot\left(dz\right)^2\\\left(dS\right)^2=c^2\left(dt\right)^2-\left(dx\right)^2-\left(dy\right)^2-\left(dz\right)^2$$

Later on, we’ll come to see that this **spacetime interval** is indeed an invariant quantity, which will prove to be very useful when deriving relativistic equations of motion (for example).
...
One of the more interesting applications of proper time is for **time dilation near a black hole’s event horizon**. I actually have an [article](https://profoundphysics.com/why-time-slows-down-near-a-black-hole/) on this exact topic, which you can understand quite well without much knowledge of general relativity.
...
Interestingly, Lorentz transformations can be used to explain **why specifically a moving charge creates a magnetic field around it**. If you want to learn more about why this happens, I discuss it in detail in [this article](https://profoundphysics.com/why-do-moving-charges-create-a-magnetic-field/). It’s an interesting read if you want to learn more about the **physical consequences** of special relativity.

Now, geometrically the Lorentz transformation can be thought of as a way to switch between coordinate systems so that the speed of light (i.e. a light ray) stays fixed. Here’s a quick animation I made showcasing this:
...
$$x=\gamma\left(\gamma\left(x-\frac{v}{c}x^0\right)+\frac{v}{c}\gamma\left(x^0-\frac{v}{c}x\right)\right)\\x=\gamma^2\left(x-\frac{v}{c}x^0\right)+\frac{v}{c}\gamma^2\left(x^0-\frac{v}{c}x\right)\\x=\gamma^2x-\gamma^2\frac{v}{c}x^0+\gamma^2\frac{v}{c}x^0-\frac{v^2}{c^2}x$$
...
$$x'=\gamma\left(x-\frac{v}{c}x^0\right)\\\left(x^0\right)'=\gamma\left(x^0-\frac{v}{c}x\right)$$
...
$$x'=\gamma\left(x-\frac{v}{c}ct\right)\\\left(ct\right)'=\gamma\left(ct-\frac{v}{c}x\right)$$

These can be simplified to be (by cancelling some of the c’s):

$$x'=\gamma\left(x-vt\right)\\t'=\gamma\left(t-\frac{v}{c^2}x\right)$$
...
This is exactly what we had before even transforming. So, from this we conclude that $S^2=\left(S'\right)^2$.
...
This exact phenomenon actually happens near a **black hole** (but not due to someone moving but rather due to the gravity of the black hole), which I discuss in great detail in [this article](https://profoundphysics.com/why-time-slows-down-near-a-black-hole/).
...
$$\left(u^0\right)^2-\left(u^1\right)^2-\left(u^2\right)^2-\left(u^3\right)^2=c^2\\\left(u^0\right)^2-\left(\left(u^1\right)^2+\left(u^2\right)^2+\left(u^3\right)^2\right)=c^2$$
...
$$\gamma^2c^2-\gamma^2v^2=c^2\\\gamma^2\left(c^2-v^2\right)=c^2$$

This relation actually reduces to simply the definition of the Lorentz factor:

$$\gamma^2=\frac{c^2}{c^2-v^2}=\frac{c^2}{c^2\left(1-\frac{v^2}{c^2}\right)}=\frac{1}{1-\frac{v^2}{c^2}}\\\gamma=\frac{1}{\sqrt{1-\frac{v^2}{c^2}}}$$
...
Now, this is all explained in my [introductory article](https://profoundphysics.com/lagrangian-mechanics-for-beginners/) on Lagrangian mechanics, so I’d recommend read that if you have absolutely no idea what I’m talking about here.
...
$$\mathscr{L}=-mc^2\frac{1}{\frac{1}{\sqrt{1-\frac{v^2}{c^2}}}}\\\mathscr{L}=-mc^2\sqrt{1-\frac{v^2}{c^2}}$$
...
This is explained much more in detail in my [article](https://profoundphysics.com/hamiltonian-mechanics-for-dummies/) on the basics of Hamiltonian mechanics, but essentially the rule of thumb is this; **the Hamiltonian of a system describes the energy of that particular system**.

Now, the most general form for the Hamiltonian function is (as explained in my Hamiltonian mechanics [article](https://profoundphysics.com/hamiltonian-mechanics-for-dummies/)):
...
$$\frac{d\gamma\left(\beta\right)}{d\beta}\left(\beta=0\right)=0\\\frac{d^2\gamma\left(\beta\right)}{d\beta^2}\left(\beta=0\right)=1\\\frac{d^3\gamma\left(\beta\right)}{d\beta^3}\left(\beta=0\right)=0\\\frac{d^4\gamma\left(\beta\right)}{d\beta^4}\left(\beta=0\right)=9\\\frac{d^5\gamma\left(\beta\right)}{d\beta^5}\left(\beta=0\right)=0\\\frac{d^6\gamma\left(\beta\right)}{d\beta^6}\left(\beta=0\right)=225$$
...
$$\begin{aligned}E&=\gamma mc^2=mc^2\left(1+\frac{1}{2}\frac{v^2}{c^2}+\frac{3}{8}\frac{v^4}{c^4}+\frac{5}{16}\frac{v^6}{c^6}+...\right)\\E&=mc^2+\frac{1}{2}mc^2\frac{v^2}{c^2}+\frac{3}{8}mc^2\frac{v^4}{c^4}+\frac{5}{16}mc^2\frac{v^6}{c^6}+...\\E&=mc^2+\frac{1}{2}mv^2+\frac{3}{8}m\frac{v^4}{c^2}+\frac{5}{16}m\frac{v^6}{c^4}+...\end{aligned}$$
...
$$u^1=\gamma v_x\\u^2=\gamma v_y\\u^3=\gamma v_z$$

So, the **spacial components of the 4-momentum** are then:

$$p^1=\gamma mv_x\\p^2=\gamma mv_y\\p^3=\gamma mv_z$$
...
$$\left(\frac{E}{c}\right)^2-p^2=m^2c^2\\\frac{E^2}{c^2}=m^2c^2+p^2$$

Multiplying both sides by c2 and taking the square root, we get:

$$E^2=m^2c^4+p^2c^2\\E=\sqrt{m^2c^4+p^2c^2}$$
...
$$F^1=\frac{dp_x}{d\tau}=\gamma\frac{dp_x}{dt}\\F^2=\frac{dp_y}{d\tau}=\gamma\frac{dp_y}{dt}\\F^3=\frac{dp_z}{d\tau}=\gamma\frac{dp_z}{dt}$$
...
$$cF_{\mu}d\tau cF^{\mu}d\tau=\left(dE\right)^2-c^2\left(dp\right)^2\\dW_{\mu}dW^{\mu}=\left(dE\right)^2-c^2\left(dp\right)^2$$
...
$$\int_{ }^{ }dW=\int_{ }^{ }qE\cdot dr\\W=q\int_{ }^{ }E\cdot dr$$
...
I realize this article turned out quite long, so I made a short video summary to highlight most of the key points we covered. You can watch it below:
...
For example, I did not discuss things like the energies and momenta for massless particles like photons. The reason I didn’t is because I actually have a whole article on this topic, which can be found [here](https://profoundphysics.com/if-photons-have-no-mass-how-can-they-have-momentum/).

If you’re looking to study more of special relativity or any related topic, I’d highly recommend checking out the **[Profound Physics course platform](https://courses.profoundphysics.com/)**, where you’ll find full courses on various topics, ranging everywhere in between beginner-focused to more advanced.
