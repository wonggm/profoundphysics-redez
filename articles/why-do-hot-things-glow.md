---
title: Why Do Hot Things Glow?
category: general-physics
date: 2024-09-05
original_url: https://profoundphysics.com/why-do-hot-things-glow/
excerpt: Blackbody radiation, Planck's quantization, and why your stove element turns red at exactly the temperature it does.
canonical: false
---

# Why Do Hot Things Glow? An In-Depth Explanation

> Blackbody radiation, Planck's quantization, and why your stove element turns red at exactly the temperature it does.

*Originally published at [profoundphysics.com](https://profoundphysics.com/why-do-hot-things-glow/).*
...
![](assets/images/why-do-hot-things-glow/img_2.webp) 
...
$$E=\frac{hc}{\lambda}\ \ \Rightarrow\ \ \lambda_{21}=\frac{hc}{E_2-E_1}$$
...
![](assets/images/why-do-hot-things-glow/img_6.webp)
...
$$\frac{dB\left(\lambda\right)}{d\lambda}=\ \frac{2hc^2}{\lambda^7\left(e^{hc/\lambda k_BT}-1\right)^2}\left(\frac{hc}{k_BT}\cdot e^{hc/\lambda k_BT}-5\lambda\left(e^{hc/\lambda k_BT}-1\right)\right)$$
...
![](assets/images/why-do-hot-things-glow/img_8.webp) 
...
$$ye^y-5\left(e^y-1\right)=0\ \ \Rightarrow\ \ \left(y-5\right)e^y=-5$$

Then, if make a second substitution y=x+5, we find:

$$\left(x+5-5\right)e^{x+5}=-5\ \ \Rightarrow\ \ xe^x=-5e^{-5}$$
...
![](assets/images/why-do-hot-things-glow/img_10.webp)
...
$$T=\frac{\alpha}{\lambda_{peak}}=\frac{\left(2.898\times10^{-3}\right)}{\left(7.5\times10^{-7}\right)}\approx3900K$$
