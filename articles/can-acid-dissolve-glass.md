---
title: Can Acid Dissolve Glass?
category: general-physics
date: 2024-09-06
original_url: https://profoundphysics.com/can-acid-dissolve-glass/
excerpt: Hydrofluoric acid is the exception — and the chemistry is genuinely surprising.
canonical: false
---

# Can Acid Dissolve Glass? The Science Explained

> Hydrofluoric acid is the exception — and the chemistry is genuinely surprising.

*Originally published at [profoundphysics.com](https://profoundphysics.com/can-acid-dissolve-glass/).*
...
Table of acids that can dissolve glass.
...
Source: [PubChem](https://pubchem.ncbi.nlm.nih.gov/periodic-table/#property=Electronegativity)
...
$$4\ HF+SiO_2\ \rightarrow\ SiF_4+2\ H_2O$$

There is also another option for a reaction that may happen, which will instead form **hexafluorosilicic acid**:

$$6\ HF+SiO_2\ \rightarrow\ H_2SiF_6+2\ H_2O$$

Both of these reactions dissolve the silicon dioxide (glass) in the process. This is because the compounds made in the reaction (silicon tetrafluoride and hexafluorosilicic acid) will both dissolve in the water that is also produced in the reaction.
...
$$SbF_5+H_2O\ \rightarrow\ 2\ HF+SbOF_3\\2\ SbF_5+5\ H_2O\ \rightarrow\ 10\ HF+Sb_2O_5$$

The hydrofluoric acid formed will then react with the silicon dioxide in glass, dissolving it. This is why for example, [the U.S. National Library of Medicine](https://pubchem.ncbi.nlm.nih.gov/compound/Antimony-pentafluoride#section=Storage-Conditions) recommends not storing antimony pentafluoride in a humid or moisty environment (as moisture contains water) nor glass containers.
...
$$HSO_3F+H_2O\ \rightarrow\ HF+H_2SO_4$$

This, of course makes its **water solution** able to dissolve glass. If heated (to about 900 °C), fluorosulfuric acid will also break down into hydrogen fluoride and some other stuff.
