---
title: Why Do Photons Have No Mass: A Simple Proof
category: general-physics
date: 2024-09-06
original_url: https://profoundphysics.com/why-do-photons-have-no-mass-simple-proof/
excerpt: If a photon had mass, Maxwell's equations would not be gauge invariant.
canonical: false
---

# Why Do Photons Not Have Mass? (Simple Proof)

> If a photon had mass, Maxwell's equations would not be gauge invariant.

*Originally published at [profoundphysics.com](https://profoundphysics.com/why-do-photons-have-no-mass-simple-proof/).*
...
This equation states that the total energy (E) of a particle is given in terms of its momentum (p) and its mass (m). This is, however, only valid for a particle which has no potential energy.
...
**Sidenote**: I actually have two articles that cover very related aspects of this topic – [this article](https://profoundphysics.com/how-are-photons-affected-by-gravity-if-they-have-no-mass/), covering **how photons are affected by gravity** (such as getting deflected near a star) even though they are massless – as well as [this article](https://profoundphysics.com/if-photons-have-no-mass-how-can-they-have-momentum/), which covers the fact that **photons still have momentum despite having zero mass**.
...
$$m=\frac{E}{c^2}\sqrt{1-\frac{c^2}{c^2}}=\frac{E}{c^2}\sqrt{1-1}=0$$
...
![](assets/images/why-do-photons-have-no-mass-simple-proof/img_2.webp) 
...
![](assets/images/why-do-photons-have-no-mass-simple-proof/img_4.webp)
